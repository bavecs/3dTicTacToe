...
export default function Home() {
  ...
  const newRoomHandler = () => {
    ...
    setERoom(newRoomId)
    window.location.replace('./room/' + newRoomId)
  ...
  return (
    <HallLayout >
      ...
      <button onClick={newRoomHandler} className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        New room
      </button>

      <a href="./room/" className='text-blue-700 underline text-sm text-center'>All room</a>
    </HallLayout>
  )
}
